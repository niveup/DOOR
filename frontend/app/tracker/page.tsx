        ...
        <div className="relative grid gap-5 px-5 py-5 sm:grid-cols-[1fr_auto] sm:items-center sm:px-6">
          ...
          <div className="relative flex flex-wrap items-center gap-2">
            <button
              ...
              className="focus-ring inline-flex items-center gap-2 rounded-lg border border-white/20 bg-white/10 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-white/15 cursor-pointer"
            >
